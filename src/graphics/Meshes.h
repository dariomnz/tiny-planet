...
std::vector<VertexPN> makeBox(float x0, float x1, float y0, float y1, float z0, float z1);

inline std::vector<VertexPN> makePlayerCube() { return makeBox(-0.5f, 0.5f, -0.5f, 0.5f, 0.0f, 2.0f); }

inline std::vector<VertexPN> makeNose() { return makeBox(0.5f, 0.75f, -0.25f, 0.25f, 1.1f, 1.6f); }
